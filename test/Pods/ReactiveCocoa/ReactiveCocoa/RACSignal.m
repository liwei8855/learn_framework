...
- (RACSignal *)bind:(RACStreamBindBlock (^)(void))block {
	 ...
	 */
/*3   block5*/
    // [RACSignal createSignal] 内部会创建RACDynamicSignal用didSubscribe把block6 copy保存起来。返回一个RACDynamicSignal的bindSignal
	return [[RACSignal createSignal:^(id<RACSubscriber> subscriber) {//block6  这里return的是bindsignal
/*5   block6*/
        //.在block6 的第一句代码，即RACStreamBindBlock bindingBlock = block()，这里的block是外面传进来的block2，于是开始调用block2
