...
/**
 ...
 RKObjectManager类提供了一个集中式接口，用于执行基于对象映射的HTTP请求和响应操作。 它封装了诸如请求/响应描述符和路由之类的通用配置，提供了NSURLRequest和RKObjectRequestOperation对象的创建，以及为基本HTTP请求方法（GET，POST，PUT， 删除等）
